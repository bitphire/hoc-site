...
export default function SignUpPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessages = {
        EmailCreateAccount: "EMAIL_ALREADY_EXISTS - TRY_SIGNIN_INSTEAD",
        CredentialsSignin: "ACCOUNT_CREATION_FAILED - TRY_AGAIN",
        AccessDenied: "ACCESS_DENIED - CONTACT_ADMIN",
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            >
              {loading ? "CREATING_ACCOUNT..." : "REGISTER_ADMIN"}
            </button>
